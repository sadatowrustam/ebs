...
exports.addCategory = catchAsync(async(req, res) => {
    const newCategory = await Servicecategory.create(req.body);
...
exports.getAllCategories = catchAsync(async(req, res, next) => {
    ...
    const count=await Servicecategory.count({where})
...
exports.deleteCategory = catchAsync(async(req, res, next) => {
    ...
    const category = await Servicecategory.findOne({ where: { id } });
